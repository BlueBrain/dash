...
The goal of DASH is to address generic, efficient multi-threaded data access and
data distribution and synchronization in a heterogenous environment. The primary
use case is the development of task-parallel multi-core, distributed
application. The implementation of data parallel operations is possible, but is
not facilitated by dash.
